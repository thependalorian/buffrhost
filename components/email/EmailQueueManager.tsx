...
export default function EmailQueueManager() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setQueue([
        { id: 'q1', email_type: 'booking_confirmation', recipient_email: 'test1@example.com', subject: 'Your Booking', status: 'pending', attempts: 0 },
        { id: 'q2', email_type: 'check_in_reminder', recipient_email: 'test2@example.com', subject: 'Check-in Soon', status: 'failed', attempts: 3 },
      ]);
      setLoading(false);
    }, 1000);
  }, []);
