...
export function EmailNotificationList() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setNotifications([
        { id: 'n1', subject: 'Your Booking is Confirmed!', created_at: new Date().toISOString(), read: false },
        { id: 'n2', subject: 'New Feature Alert', created_at: new Date(Date.now() - 86400000).toISOString(), read: true },
      ]);
      setLoading(false);
    }, 1000);
  }, []);
