...
-- =============================================================================
-- This schema extends the existing CMS to provide comprehensive property management
-- for all property types including restaurants, hotels, and other services

-- =============================================================================
-- PROPERTY OWNERS TABLE (Enhanced)
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS property_analytics (
    ...
    property_id UUID NOT NULL REFERENCES properties(id) ON DELETE CASCADE,
    date DATE NOT NULL,
    metric_type VARCHAR(50) NOT NULL, -- 'views', 'bookings', 'revenue', 'occupancy', 'reviews', 'menu_views', 'service_bookings'
