...
output "hospitality_data_bucket" {
  description = "Hospitality data storage bucket name"
  value       = var.create_hospitality_storage ? google_storage_bucket.hospitality_data[0].name : null
}

output "property_images_bucket" {
  description = "Property images storage bucket name"
  value       = var.create_image_storage ? google_storage_bucket.property_images[0].name : null
}
