...
print_info "Setting up Langfuse integration (skipping dependency installation)..."
...
# 2. Create Langfuse configuration files
...
# 3. Create Docker Compose configuration for Langfuse
...
# 5. Create README for Langfuse integration
...
chmod +x scripts/setup-langfuse-simple.sh
chmod +x scripts/verify-langfuse-setup.sh
...
echo "2. Get your API keys from https://cloud.langfuse.com"
echo "3. Install dependencies: pip install -r microservices/ai-service/requirements.txt"
echo "4. Run: ./scripts/verify-langfuse-setup.sh"
echo "5. Start services: docker-compose -f docker-compose.langfuse.yml up"
echo "6. Test AI endpoints at http://localhost:8012"
echo "7. View traces in your Langfuse dashboard"
echo ""
