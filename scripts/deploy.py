...
This script deploys the BuffrHost (Buffr Host) fintech platform stack with different configurations:
...
def main():
    parser = argparse.ArgumentParser(
        description='Deploy the BuffrHost (Buffr Host) Fintech Platform stack',
