...
CREATE TABLE RoomType (
    ...
    type_class room_type_class_enum NOT NULL,
    description TEXT,
...
CREATE TABLE RoomReservation (
    ...
    reservation_status reservation_status_enum DEFAULT 'confirmed',
...
CREATE TABLE RoomRate (
    ...
    rate_type room_rate_type_enum NOT NULL,
    base_rate NUMERIC(10,2) NOT NULL,
...
CREATE TABLE RoomServiceOrder (
    ...
    room_id INTEGER REFERENCES Room(room_id) ON DELETE CASCADE,
    customer_id UUID REFERENCES Customer(customer_id),
    order_status room_service_status_enum DEFAULT 'pending',
