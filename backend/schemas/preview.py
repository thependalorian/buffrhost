...
class PreviewRequest(BaseModel):
    ...
    preview_type: str = Field(default="visitor", description="Type of preview (visitor, admin, etc.)")
...
class MenuPreviewData(BaseModel):
    ...
    restaurant_description: Optional[str] = Field(None, description="Restaurant description")
    ...
    show_allergens: bool = Field(default=True, description="Whether to show allergen information")
    show_calories: bool = Field(default=False, description="Whether to show calorie information")
...
class PropertyPreviewData(BaseModel):
    ...
    services: List[Dict[str, Any]] = Field(default_factory=list, description="Property services")
    ...
    policies: Optional[List[Dict[str, Any]]] = Field(None, description="Property policies")
