...
class DocumentManagement(Base):
    ...
    document_id = Column(UUID(as_uuid=True), primary_key=True, default=func.uuid_generate_v4())
...
class DocumentAccessLog(Base):
    ...
    access_id = Column(UUID(as_uuid=True), primary_key=True, default=func.uuid_generate_v4())
    document_id = Column(UUID(as_uuid=True), ForeignKey("documentmanagement.document_id"))
