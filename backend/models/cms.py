...
class CMSContent(Base):
    ...
    content_type = Column(
        ENUM(ContentType, name="content_type_enum", create_type=False), nullable=False
    )
    status = Column(
...
class ContentTemplate(Base):
    ...
    template_type = Column(
        ENUM(ContentType, name="template_type_enum", create_type=False), nullable=False
    )
...
class CollectionContent(Base):
    ...
    collection_id = Column(
        Integer, ForeignKey("cms_content_collection.id"), nullable=False
    )
    content_id = Column(Integer, ForeignKey("cms_content.id"), nullable=False)
...
class ContentWorkflow(Base):
    ...
    content_id = Column(Integer, ForeignKey("cms_content.id"), nullable=False)
    status = Column(
        ENUM(ContentStatus, name="workflow_status_enum", create_type=False),
        nullable=False,
    )
