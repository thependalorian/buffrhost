...
class BuffrHostAgent:
    ...
    async def send_booking_confirmation(
        ...
        try:
            ...
            result = await self.conversational_ai.arcade_service.send_booking_confirmation(
                user_id=user_id,
    ...
    async def send_staff_notification(
        ...
        try:
            ...
            result = await self.conversational_ai.arcade_service.send_staff_notification(
                user_id=user_id,
    ...
    async def get_conversation_memories(self, user_id: str, query: str = "") -> List[Dict[str, Any]]:
        """
    ...
    def get_available_tools(self) -> List[Dict[str, Any]]:
        ...
        return self.conversational_ai.get_available_tools() if self.conversational_ai else []
    
    async def health_check(self) -> Dict[str, Any]:
        """Get agent health status."""
        return {
            "status": "healthy" if self.conversational_ai else "unhealthy",
            "arcade_available": self.conversational_ai.arcade_service.is_available if self.conversational_ai else False,
