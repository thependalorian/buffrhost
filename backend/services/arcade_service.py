...
class ArcadeService:
    ...
    async def wait_for_authorization_completion(
        ...
        try:
            ...
            return {
                ...
                "token": getattr(completed_response.context, "token", None)
                if hasattr(completed_response, "context")
                else None,
    ...
    async def execute_tool(
        self, tool_name: str, user_id: str, parameters: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
    ...
    async def create_booking_calendar_event(
        self, user_id: str, booking_details: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        try:
            parameters = {
                ...
                "attendees": [{"email": booking_details.get("customer_email")}]
    ...
    async def send_booking_confirmation(
        ...
        try:
            ...
            email_subject = (
                f"Buffr Host Booking Confirmation - {service_type} at {property_name}"
            )
            email_body = f"""
            ...
            return await self.execute_tool(
                "gmail_send_booking_confirmation", user_id, parameters
            )
        except Exception as e:
    ...
    async def create_staff_schedule_event(
        ...
        try:
            ...
            parameters = {
                ...
                "attendees": [{"email": schedule_data.get("staff_email")}]
                if schedule_data.get("staff_email")
                else [],
                "reminders": {
                    "useDefault": False,
                    "overrides": [
            ...
            return await self.execute_tool(
                "calendar_schedule_staff_shift", user_id, parameters
            )
        except Exception as e:
    ...
    async def send_kitchen_order_notification(
        ...
        try:
            ...
            parameters = {
                ...
                "blocks": [
                    ...
                    },
                    {
                        "type": "section",
                        "fields": [
                            {"type": "mrkdwn", "text": f"*Table:* {table_number}"},
                            {
                                "type": "mrkdwn",
            ...
            return await self.execute_tool(
                "slack_staff_notification", user_id, parameters
            )
        except Exception as e:
    ...
    def get_service_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "hospitality_tools": len(self.get_available_tools())
