...
class StaffService:
    ...
    def create_department(
        self, department_data: StaffDepartmentCreate
    ) -> StaffDepartment:
    ...
    def update_department(
        self, department_id: int, department_data: StaffDepartmentUpdate
    ) -> Optional[StaffDepartment]:
        """Update a department."""
    ...
    def get_positions(
        ...
        query = self.db.query(StaffPosition).filter(
            and_(
    ...
    def get_position(self, position_id: int) -> Optional[StaffPosition]:
        ...
        return (
            self.db.query(StaffPosition)
            .filter(StaffPosition.position_id == position_id)
            .first()
        )

    def update_position(
        self, position_id: int, position_data: StaffPositionUpdate
    ...
    def get_schedules(
        ...
        return (
            query.order_by(StaffSchedule.schedule_date, StaffSchedule.start_time)
            .offset(skip)
            .limit(limit)
            .all()
        )
    ...
    def update_schedule(
        self, schedule_id: int, schedule_data: StaffScheduleUpdate
    ...
    def create_attendance(
        self, attendance_data: StaffAttendanceCreate
    ) -> StaffAttendance:
    ...
    def get_attendance(
        ...
        query = (
            ...
            .options(
                joinedload(StaffAttendance.staff), joinedload(StaffAttendance.schedule)
            )
        ...
        return (
            query.order_by(desc(StaffAttendance.created_at))
            .offset(skip)
            .limit(limit)
            .all()
        )
    ...
    def update_attendance(
        self, attendance_id: int, attendance_data: StaffAttendanceUpdate
    ...
    def get_tasks(
        ...
        return (
            query.order_by(desc(StaffTask.created_at)).offset(skip).limit(limit).all()
        )
    ...
    def update_task(
        self, task_id: int, task_data: StaffTaskUpdate
    ) -> Optional[StaffTask]:
        """Update a task."""
    ...
    def create_performance_review(
        self, performance_data: StaffPerformanceCreate
    ) -> StaffPerformance:
    ...
    def get_performance_reviews(
        ...
        query = (
            self.db.query(StaffPerformance)
        ...
        return (
            query.order_by(desc(StaffPerformance.created_at))
            .offset(skip)
            .limit(limit)
            .all()
        )
    ...
    def update_performance_review(
        self, performance_id: int, performance_data: StaffPerformanceUpdate
    ) -> Optional[StaffPerformance]:
    ...
    def create_communication(
        self, communication_data: StaffCommunicationCreate
    ) -> StaffCommunication:
    ...
    def get_communications(
        ...
        query = (
            self.db.query(StaffCommunication)
            .options(
        ...
        if communication_type:
            query = query.filter(
                StaffCommunication.communication_type == communication_type
            )
        ...
        return (
            query.order_by(desc(StaffCommunication.created_at))
            .offset(skip)
            .limit(limit)
            .all()
        )
    ...
    def update_communication(
        self, communication_id: int, communication_data: StaffCommunicationUpdate
    ) -> Optional[StaffCommunication]:
    ...
    def create_leave_request(
        self, leave_data: StaffLeaveRequestCreate
    ) -> StaffLeaveRequest:
    ...
    def get_leave_requests(
        ...
        skip: int = 0,
        limit: int = 100,
    ) -> List[StaffLeaveRequest]:
        """Get leave requests with optional filters."""
        query = (
            self.db.query(StaffLeaveRequest)
        ...
        return (
            query.order_by(desc(StaffLeaveRequest.requested_at))
            .offset(skip)
            .limit(limit)
            .all()
        )
    ...
    def update_leave_request(
        self, leave_request_id: int, leave_data: StaffLeaveRequestUpdate
    ) -> Optional[StaffLeaveRequest]:
    ...
    def get_staff_analytics(
        ...
        # Attendance summary
        attendance_query = self.db.query(StaffAttendance).filter(
            StaffAttendance.property_id == property_id
        )

        if start_date:
            attendance_query = attendance_query.filter(
                func.date(StaffAttendance.created_at) >= start_date
            )
        if end_date:
            attendance_query = attendance_query.filter(
                func.date(StaffAttendance.created_at) <= end_date
            )
        ...
        return {
            ...
            "department_distribution": [
                {"department": d.department_name, "count": d.staff_count}
