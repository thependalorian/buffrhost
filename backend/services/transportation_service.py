...
from models.services import TransportationService, ServiceBooking
from models.vehicle import Vehicle
from schemas.transportation import TransportationService as TransportationServiceSchema, TransportationBooking as TransportationBookingSchema, TransportationBookingCreate, TransportationVehicle as TransportationVehicleSchema
...
class TransportationServiceClass:
    ...
    async def get_transportation_services(
        ...
        query = select(TransportationService).where(TransportationService.property_id == property_id).offset(skip).limit(limit)
    ...
    async def get_vehicles(
        ...
        query = select(Vehicle).where(Vehicle.property_id == property_id).offset(skip).limit(limit)
        result = await self.db.execute(query)
