...
class NotificationService:
    ...
    async def send_email(
        ...
        try:
            ...
            if self.smtp_host and self.smtp_username and self.smtp_password:
                ...
                logger.info(f"SMTP not configured, logging email to {to_email}: {subject}")
    ...
    async def send_sms(
        ...
        try:
            ...
            if self.twilio_account_sid and self.twilio_auth_token and self.twilio_phone_number:
                ...
                logger.info(f"Twilio not configured, logging SMS to {to_phone}: {message}")
    ...
    async def send_push_notification(
        ...
        try:
            ...
            if firebase_server_key and self.push_enabled:
                ...
                logger.info(f"Firebase not configured, logging push notification to user {user_id}: {title}")
    ...
    def _generate_email_content(self, template: str, data: Dict[str, Any]) -> Dict[str, str]:
    ...
    async def _send_webhook_notification(self, webhook_url: str, payload: Dict[str, Any]) -> None:
