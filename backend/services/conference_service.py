...
from schemas.conference import ConferenceRoom as ConferenceRoomSchema, ConferenceBooking as ConferenceBookingSchema, ConferenceBookingCreate
...
class ConferenceService:
    ...
    async def get_conference_rooms(
        ...
        query = select(ConferenceRoom).where(ConferenceRoom.property_id == property_id).offset(skip).limit(limit)
