...
class VoiceModelSetup:
    ...
    def install_system_dependencies(self) -> bool:
        ...
        try:
            ...
            logger.warning("apt-get not found. Please install espeak-ng and ffmpeg manually.")
            return False
    ...
    def download_whisper_model(self) -> bool:
        ...
        try:
            ...
            model = whisper.load_model("base", download_root=self.models_dir / "whisper")
    ...
    def setup_voice_config(self) -> bool:
        ...
        try:
            config = {
                "tts_models": {
                    "kokoro": {
                        "model_path": str(self.models_dir / "kokoro" / "kokoro-v0_19.onnx"),
                        "voices": [
