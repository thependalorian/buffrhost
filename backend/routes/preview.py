...
from schemas.preview import (DraftContent, PreviewRequest, PreviewResponse,
                             PreviewStatus, PreviewType)
...
async def get_preview_content(preview_id: str, db: AsyncSession = Depends(get_db)):
    """
    ...
    try:
        ...
        if datetime.utcnow() > expires_at:
            ...
            raise HTTPException(
                status_code=status.HTTP_410_GONE, detail="Preview has expired"
            )
...
async def get_user_drafts(
    ...
    try:
        ...
        user_drafts = [
            ...
            and preview_data["status"] == PreviewStatus.DRAFT
        ]
...
async def get_preview_analytics(
    ...
    try:
        ...
        analytics = {
            ...
            "device_breakdown": {"mobile": 65, "desktop": 25, "tablet": 10},
