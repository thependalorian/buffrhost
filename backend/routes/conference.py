...
from schemas.conference import (ConferenceAmenity, ConferenceBooking,
                                ConferenceBookingCreate, ConferencePackage,
                                ConferenceRoom)
...
@router.get(
    "/{property_id}/conference/bookings", response_model=List[ConferenceBooking]
)
async def get_conference_bookings(
    ...
    conference_service = ConferenceService(db)
    return await conference_service.get_conference_bookings(
...
async def create_conference_booking(
    ...
    conference_service = ConferenceService(db)
    try:
        return await conference_service.create_conference_booking(
...
@router.get(
    "/{property_id}/conference/amenities", response_model=List[ConferenceAmenity]
)
...
@router.get(
    "/{property_id}/conference/packages", response_model=List[ConferencePackage]
)
