...
from models.inventory import InventoryItem, UnitOfMeasurement
from models.user import User
from routes.auth import get_current_user
from schemas.inventory import (InventoryItemCreate, InventoryItemResponse,
                               InventoryItemSummary, InventoryItemUpdate,
                               LowStockAlert, StockUpdate, UnitCreate,
                               UnitResponse)
...
@router.post(
    "/restaurants/{restaurant_id}/units",
...
async def create_unit(
    ...
    unit = UnitOfMeasurement(restaurant_id=restaurant_id, **unit_data.dict())
...
# Inventory Items
@router.get(
    "/restaurants/{restaurant_id}/inventory", response_model=List[InventoryItemResponse]
)
...
async def create_inventory_item(
    ...
    inventory_item = InventoryItem(restaurant_id=restaurant_id, **inventory_data.dict())
...
@router.get(
    "/restaurants/{restaurant_id}/inventory/{inventory_id}",
    response_model=InventoryItemResponse,
)
...
@router.put(
    "/restaurants/{restaurant_id}/inventory/{inventory_id}/stock",
    response_model=InventoryItemResponse,
)
...
@router.get(
    "/restaurants/{restaurant_id}/inventory/low-stock",
