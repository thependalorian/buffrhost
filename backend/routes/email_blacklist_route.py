...
async def get_email_blacklist():
    ...
    mock_blacklist = [
        {"id": "bl1", "email": "spam1@example.com", "reason": "User complaint", "created_at": "2025-09-01T00:00:00Z"},
        {"id": "bl2", "email": "spam2@example.com", "reason": "Hard bounce", "created_at": "2025-09-10T00:00:00Z"},
    ]
