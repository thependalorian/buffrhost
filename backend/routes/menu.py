...
from schemas.menu import (MenuCategoryCreate, MenuCategoryResponse,
                          ...
                          MenuItemSummary, MenuItemUpdate, MenuMediaCreate,
                          MenuMediaResponse)
...
@router.put(
    "/restaurants/{restaurant_id}/menu-categories/{category_id}",
    response_model=MenuCategoryResponse,
)
...
# Menu Items
@router.get(
    "/restaurants/{restaurant_id}/menu-items", response_model=List[MenuItemResponse]
)
...
async def create_menu_item(
    ...
    menu_item = Menu(restaurant_id=restaurant_id, **menu_data.dict())
...
async def get_menu_item(
    ...
    result = await db.execute(
        select(Menu).where(
            and_(Menu.menu_item_id == menu_item_id, Menu.restaurant_id == restaurant_id)
        )
    )
