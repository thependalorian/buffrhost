...
class TestMenuService:
    ...
    def test_get_popular_menu_items(self, menu_service, mock_db_session, sample_menu_item):
    ...
    def test_get_popular_menu_items_with_none_values(self, menu_service, mock_db_session):
    ...
    def test_get_popular_menu_items_limit_parameter(self, menu_service, mock_db_session):
    ...
    def test_get_popular_menu_items_property_id_filter(self, menu_service, mock_db_session):
    ...
    def test_get_popular_menu_items_result_structure(self, menu_service, mock_db_session):
    ...
    def test_get_popular_menu_items_float_conversion(self, menu_service, mock_db_session):
