...
from models.hr_payroll import \
    Employee  # Assuming Employee is defined here for schedules
...
async def test_create_booking(
    ...
    response = await client.post(
        "/calendar-scheduling/bookings", json=booking_data, headers=auth_headers
    )
