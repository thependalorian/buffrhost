...
class TestRoom:
    ...
    def test_create_room(
        self, db_session: Session, sample_hospitality_property, sample_room_type
    ):
...
class TestMenuCategory:
    ...
    def test_create_menu_category(
        self, db_session: Session, sample_hospitality_property
    ):
...
class TestMenuItem:
    ...
    def test_create_menu_item(
        self, db_session: Session, sample_hospitality_property, sample_menu_category
    ):
...
class TestLoyaltyProgram:
    ...
    def test_create_loyalty_program(
        self, db_session: Session, sample_hospitality_property
    ):
...
class TestKnowledgeBase:
    ...
    def test_create_knowledge_base_entry(
        self, db_session: Session, sample_hospitality_property
    ):
...
class TestAIAgentSession:
    ...
    def test_create_ai_agent_session(
        self, db_session: Session, sample_customer, sample_hospitality_property
    ):
...
class TestModelRelationships:
    ...
    def test_property_room_type_relationship(
        self, db_session: Session, sample_hospitality_property
    ):
    ...
    def test_property_menu_relationship(
        self, db_session: Session, sample_hospitality_property
    ):
        """Test relationship between property and menu items."""
        category = MenuCategory(
            property_id=sample_hospitality_property.id, name="Desserts", display_order=3
        )
