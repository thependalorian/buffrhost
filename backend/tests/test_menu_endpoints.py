...
def test_get_menu_categories(client: TestClient, sample_user_admin, sample_hospitality_property):
    """Test getting menu categories for a restaurant."""
    # Mock authentication
    with patch('routes.menu.get_current_user', return_value=sample_user_admin):
        response = client.get(f"/api/v1/restaurants/{sample_hospitality_property.property_id}/menu-categories")
        assert response.status_code == 200
        data = response.json()
        assert isinstance(data, list)

def test_create_menu_category(client: TestClient, sample_user_admin, sample_hospitality_property):
...
def test_update_menu_category(client: TestClient, sample_user_admin, sample_hospitality_property, sample_menu_category):
...
def test_delete_menu_category(client: TestClient, sample_user_admin, sample_hospitality_property, sample_menu_category):
...
def test_get_menu_items(client: TestClient, sample_user_admin, sample_hospitality_property):
    """Test getting menu items for a restaurant."""
    with patch('routes.menu.get_current_user', return_value=sample_user_admin):
        response = client.get(f"/api/v1/restaurants/{sample_hospitality_property.property_id}/menu-items")
        assert response.status_code == 200
        data = response.json()
        assert isinstance(data, list)

def test_get_menu_items_with_filters(client: TestClient, sample_user_admin, sample_hospitality_property, sample_menu_category):
...
def test_get_menu_items_with_availability_filter(client: TestClient, sample_user_admin, sample_hospitality_property):
...
def test_get_menu_items_with_pagination(client: TestClient, sample_user_admin, sample_hospitality_property):
...
def test_create_menu_item(client: TestClient, sample_user_admin, sample_hospitality_property, sample_menu_category):
...
def test_get_menu_item(client: TestClient, sample_user_admin, sample_hospitality_property, sample_menu_item):
...
def test_update_menu_item(client: TestClient, sample_user_admin, sample_hospitality_property, sample_menu_item):
...
def test_delete_menu_item(client: TestClient, sample_user_admin, sample_hospitality_property, sample_menu_item):
...
def test_menu_item_not_found(client: TestClient, sample_user_admin, sample_hospitality_property):
...
def test_menu_category_not_found(client: TestClient, sample_user_admin, sample_hospitality_property):
...
def test_access_denied_for_different_restaurant(client: TestClient, sample_user_guest, sample_hospitality_property):
...
def test_create_menu_item_with_invalid_category(client: TestClient, sample_user_admin, sample_hospitality_property):
...
def test_menu_items_pagination_limits(client: TestClient, sample_user_admin, sample_hospitality_property):
...
def test_menu_items_negative_pagination(client: TestClient, sample_user_admin, sample_hospitality_property):
...
def test_menu_item_validation(client: TestClient, sample_user_admin, sample_hospitality_property, sample_menu_category):
