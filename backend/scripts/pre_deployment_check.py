...
def test_docker_build() -> bool:
    ...
    success, stdout, stderr = run_command(
        "docker build --no-cache -t shandi-backend-test .", cwd=backend_dir
    )
...
def test_requirements_consistency() -> bool:
    ...
    success, stdout, stderr = run_command(
        f"{sys.executable} validate_dependencies.py", cwd=script_dir
    )
...
def test_import_validation() -> bool:
    ...
    success, stdout, stderr = run_command(
        f"{sys.executable} validate_imports.py", cwd=script_dir
    )
