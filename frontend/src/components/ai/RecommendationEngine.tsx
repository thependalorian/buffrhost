...
export const RecommendationEngine: React.FC<RecommendationEngineProps> = ({
  ...
  const { trackRecommendations, trackUserInteraction, trackError } = useLangfuseTrace();
      ...
      return [
        {
          ...
          description: 'Premium suite with stunning ocean views and luxury amenities',
          type: 'room',
          confidence: 0.85,
        ...
        },
        {
          ...
          description: 'Relaxing spa experience with massage and wellness treatments',
          type: 'service',
          confidence: 0.80,
          metadata: { source: 'default' },
        },
        {
          ...
          description: 'Exquisite culinary journey at our award-winning restaurant',
          type: 'experience',
          confidence: 0.75,
          metadata: { source: 'default' },
        },
  ...
  const determineRecommendationType = (title: string): Recommendation['type'] => {
    const lowerTitle = title.toLowerCase();
    if (lowerTitle.includes('room') || lowerTitle.includes('suite')) return 'room';
    if (lowerTitle.includes('spa') || lowerTitle.includes('massage')) return 'service';
    if (lowerTitle.includes('dining') || lowerTitle.includes('restaurant')) return 'experience';
    return 'amenity';
  };
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">AI-powered suggestions just for you</p>
          </div>
          <button
            onClick={loadRecommendations}
            disabled={isLoading}
