// Uwaitlist - Service
/**
 * Waitlist Type Definitions for Buffr Host Hospitality Platform
 * @fileoverview Waitlist type definitions for waitlist management and lead generation
 * @location buffr-host/lib/types/waitlist.ts
 * @purpose waitlist type definitions for waitlist management and lead generation
 ...
 * import type { Uwaitlist } from './waitlist';
 *
 * // Usage in component
 ...
 *
 * Exported Types:
 * @typedef {TypeDefinition} Uwaitlist
 *
