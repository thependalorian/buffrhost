// Ubooking - Service
/**
 * Booking Type Definitions for Buffr Host Hospitality Platform
 * @fileoverview Booking type definitions for reservation and booking management systems
 * @location buffr-host/lib/types/booking.ts
 * @purpose booking type definitions for reservation and booking management systems
 ...
 * import type { Ubooking } from './booking';
 *
 * // Usage in component
 ...
 *
 * Exported Types:
 * @typedef {TypeDefinition} Ubooking
 *
