...
describe("Etuna Dashboard", () => {
  ...
  it("shows recent activity section", () => {
    ...
    expect(
      screen.getByText("New booking from Corporate Retreat Group"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("Guest checked out from Room 101"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("Restaurant order completed for Table 5"),
    ).toBeInTheDocument();
  });
