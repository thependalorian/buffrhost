...
describe("Etuna Waitlist", () => {
  ...
  it("displays compelling headline", () => {
    ...
    expect(
      screen.getByText("Transform Your Hospitality Business"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("Join 500+ businesses already on the waitlist"),
    ).toBeInTheDocument();
  });
  ...
  it("shows platform capabilities", () => {
    ...
    expect(
      screen.getByText("AI Receptionist & Booking Agent"),
    ).toBeInTheDocument();
  ...
  it("shows urgency messaging", () => {
    ...
    expect(
      screen.getByText("Only 100 spots remaining for early access"),
    ).toBeInTheDocument();
  });
  ...
  it("shows platform features grid", () => {
    ...
    expect(
      screen.getByText("Complete Hospitality Ecosystem"),
    ).toBeInTheDocument();
