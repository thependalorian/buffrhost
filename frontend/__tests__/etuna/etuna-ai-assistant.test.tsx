...
describe("Etuna AI Assistant", () => {
  ...
  it("displays welcome message and capabilities", () => {
    ...
    expect(
      screen.getByText("Welcome to Etuna Guesthouse & Tours!"),
    ).toBeInTheDocument();
    expect(
      screen.getByText(
        /I'm here to help you with bookings, tours, dining, and any questions about your stay/,
      ),
    ).toBeInTheDocument();
  });
  ...
  it("shows system status indicators", () => {
    ...
    expect(
      screen.getByText(
        "Enhanced AI with double-booking prevention and escalation handling",
      ),
    ).toBeInTheDocument();
  });
  ...
  it("displays contact information", () => {
    ...
    expect(
      screen.getByText("5544 Valley Street, Ongwediva"),
    ).toBeInTheDocument();
  ...
  it("renders chat interface elements", () => {
    ...
    expect(
      screen.getByText("Ask me anything about your stay..."),
    ).toBeInTheDocument();
