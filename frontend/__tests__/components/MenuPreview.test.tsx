...
describe("MenuPreview", () => {
  ...
  it("renders when isOpen is true", () => {
    ...
    expect(
      screen.getByText("Menu Preview: Test Restaurant"),
    ).toBeInTheDocument();
    expect(screen.getByText("Test Restaurant")).toBeInTheDocument();
    expect(
      screen.getByText("A wonderful dining experience"),
    ).toBeInTheDocument();
  });
  ...
  it("does not render when isOpen is false", () => {
    ...
    expect(
      screen.queryByText("Menu Preview: Test Restaurant"),
  ...
  it("hides allergens when showAllergens is false", () => {
    ...
    expect(
      screen.queryByText("Warning: Contains: dairy"),
    ).not.toBeInTheDocument();
  });
