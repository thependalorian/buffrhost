...
describe('Revenue Model Components and Pages', () => {
  ...
  test('CommissionStructureList renders correctly', () => {
    ...
    expect(screen.getByText(/Loading commission structures.../i)).toBeInTheDocument();
  });
  ...
  test('FeesPage renders correctly', () => {
    render(<FeesPage />);
    expect(screen.getByRole('heading', { name: /Service Fee Management/i })).toBeInTheDocument();
  });

  test('CommissionsPage renders correctly', () => {
    render(<CommissionsPage />);
    expect(screen.getByRole('heading', { name: /Commission Management/i })).toBeInTheDocument();
  });
