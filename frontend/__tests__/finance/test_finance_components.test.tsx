...
describe("Banking & Financial Components and Pages", () => {
  ...
  test("PaymentGatewayList renders correctly", () => {
    ...
    expect(
      screen.getByText(/Loading payment gateways.../i),
    ).toBeInTheDocument();
  });
  ...
  test("BankAccountsPage renders correctly", () => {
    ...
    expect(
      screen.getByRole("heading", { name: /Bank Account Management/i }),
    ).toBeInTheDocument();
  });
  ...
  test("PaymentGatewaysPage renders correctly", () => {
    ...
    expect(
      screen.getByRole("heading", { name: /Payment Gateway Management/i }),
    ).toBeInTheDocument();
  });
  ...
  test("DisbursementsPage renders correctly", () => {
    ...
    expect(
      screen.getByRole("heading", { name: /Disbursement Management/i }),
    ).toBeInTheDocument();
  });
});
