  ...
  return (
    <div className="min-h-screen bg-nude-50">
        ...
        <div className="container-warm">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="body-large mb-8 text-nude-700">
              Whether you're staying at a hotel or dining at a restaurant, we're
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                <BuffrIcon name="arrow-right" className="ml-2 h-5 w-5" />
              </BuffrButton>
      ...
      <section className="section-warm bg-white">
        <div className="container-warm">
          <div className="text-center mb-16">
            <h2 className="heading-section mb-4">Choose Your Experience</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="card-default card-interactive">
              ...
              <p className="body-regular text-nude-700 mb-6">
                Book rooms, access hotel services, order room service, and enjoy
                all the amenities of your stay.
              </p>
            ...
            <div className="card-default card-interactive">
              <BuffrIcon
                name="utensils"
                className="h-12 w-12 text-luxury-charlotte mb-6"
              />
              <h3 className="heading-card mb-4">Restaurant & Dining</h3>
              <p className="body-regular text-nude-700 mb-6">
                Browse menus, make reservations, place orders, and enjoy
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center text-nude-600">
                  <BuffrIcon name="user" className="h-4 w-4 mr-2" />
      ...
      <section className="section-warm">
        <div className="container-warm">
          <div className="text-center mb-16">
            <h2 className="heading-section mb-4">Why Choose Our Platform?</h2>
            <p className="body-large text-nude-700">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-luxury-charlotte rounded-full flex items-center justify-center mx-auto mb-4">
                <BuffrIcon name="star" className="h-8 w-8 text-white" />
              </div>
              <h3 className="heading-card mb-3">AI-Powered Service</h3>
              <p className="body-regular text-nude-600">
                Our AI concierge understands your needs and provides
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-nude-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <BuffrIcon name="user" className="h-8 w-8 text-white" />
              </div>
              <h3 className="heading-card mb-3">Personalized Experience</h3>
              <p className="body-regular text-nude-600">
                Every interaction is tailored to your preferences and past
                experiences.
              </p>
            </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-luxury-charlotte rounded-full flex items-center justify-center mx-auto mb-4">
                <BuffrIcon name="calendar" className="h-8 w-8 text-white" />
              </div>
