...
export default function GuestPortalPage() {
  return (
    <div className="container mx-auto p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-base-content">Welcome to Buffr Host</h1>
          ...
          <div className="card-body">
            ...
            <div className="form-control mt-4">
              <div className="input-group">
                <input type="text" placeholder="Ask me anything..." className="input input-bordered flex-1" />
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-base-content/70">Windhoek, Namibia</div>
