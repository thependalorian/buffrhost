...
export default function EtunaMenuPage() {
  const [activeTab, setActiveTab] = useState<"restaurant" | "bar">(
    "restaurant",
  );
    ...
    restaurant: [
      {
        ...
        currency: "NAD",
        image:
          "https://images.unsplash.com/photo-1598515214211-89d88c13e162?q=80&w=2070&auto=format&fit=crop",
      ...
      },
      {
        ...
        currency: "NAD",
        image:
          "https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?q=80&w=2070&auto=format&fit=crop",
        availability: "available",
        preparationTime: "15-20 min",
        rating: 4.4,
        reviews: 25,
      ...
      },
      {
        ...
        currency: "NAD",
        image:
          "https://images.unsplash.com/photo-1574484284002-952d92456975?q=80&w=2070&auto=format&fit=crop",
        availability: "limited",
      ...
      },
      {
        ...
        currency: "NAD",
        image:
          "https://images.unsplash.com/photo-1567620832904-9fe5cf23db13?q=80&w=2070&auto=format&fit=crop",
        availability: "available",
        preparationTime: "20-25 min",
        rating: 4.3,
        reviews: 42,
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-primary-content/80 max-w-3xl mx-auto">
              Authentic Namibian cuisine and full bar service with traditional
              flavors and modern presentation
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-base-200 py-4">
        <div className="container mx-auto px-6">
          <div className="flex justify-center gap-4">
            <button
              className={`btn ${
                activeTab === "restaurant" ? "btn-primary" : "btn-outline"
              }`}
            ...
            <button
              className={`btn ${
                activeTab === "bar" ? "btn-primary" : "btn-outline"
              }`}
              ...
              <figure className="h-48 relative">
                ...
                <div className="absolute top-4 right-4 flex gap-2">
                  ...
                  >
                    ...
                    {item.availability.charAt(0).toUpperCase() +
                      item.availability.slice(1)}
                  </div>
                </div>
