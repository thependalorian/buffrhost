  ...
  return (
    <div className="min-h-screen nude-gradient-light flex items-center justify-center">
      <div className="text-center">
        ...
        <h2 className="text-xl font-semibold mb-2 text-nude-900">Upgrading AI Assistant</h2>
        <p className="text-nude-800">Redirecting to the new professional interface...</p>
      </div>
    </div>
  );
}
