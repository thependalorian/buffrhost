...
export const metadata: Metadata = {
  title: 'Services & Facilities - Etuna Guesthouse & Tours',
  description: 'Discover our comprehensive services including camping, laundry, conference facilities, and more at Etuna Guesthouse.',
};
  ...
  const services = [
    {
      ...
      description: 'Experience the great outdoors with our well-equipped camping facilities. Perfect for adventure seekers and nature lovers.',
      price: 200,
      currency: 'NAD',
      perUnit: 'per person per night',
      image: 'https://images.unsplash.com/photo-1551524164-6cf2ac5313f7?q=80&w=2070&auto=format&fit=crop',
    ...
    },
    {
      ...
      description: 'Professional laundry and dry cleaning services for all your clothing needs during your stay.',
      price: 50,
      currency: 'NAD',
      perUnit: 'per item',
    ...
    },
    {
      ...
      category: 'Business',
      description: 'Professional conference hall for meetings, trainings, seminars, and corporate events with modern amenities.',
      price: 1500,
      currency: 'NAD',
      perUnit: 'per day',
    ...
    },
    {
      ...
      description: 'Convenient airport pickup and drop-off service to and from Ondangwa Airport.',
      price: 300,
      currency: 'NAD',
      perUnit: 'per trip',
    ...
    },
    {
      ...
      name: 'Swimming Pool',
      category: 'Recreation',
      description: 'Relax and unwind in our clean, well-maintained swimming pool with comfortable seating areas.',
      price: 0,
      currency: 'NAD',
    ...
    },
    {
      ...
      description: 'Exclusive bar service for private events, celebrations, and special occasions.',
      price: 800,
      currency: 'NAD',
      perUnit: 'per event',
      image: 'https://images.unsplash.com/photo-1514933651103-005eec06c04b?q=80&w=2070&auto=format&fit=crop',
      availability: 'available',
            ...
            <div key={service.id} className="card bg-base-100 shadow-xl">
              <figure className="h-64 relative">
                ...
                <div className="absolute top-4 right-4 flex gap-2">
                  ...
                  <div className={`badge ${getAvailabilityColor(service.availability)} gap-1`}>
              ...
              <div className="card-body">
                  ...
                  <div className="text-right">
                    {service.price === 0 ? (
                      ...
                      <div className="text-2xl font-bold text-primary">
                        ...
                        <span className="text-sm font-normal text-base-content/70">/{service.perUnit}</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 mb-4">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-xs text-base-content/70">({service.reviews})</span>
                  </div>
                  <div className="flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body text-center">
                ...
                <p className="text-base-content/70">Round-the-clock security for your peace of mind</p>
              </div>
            </div>
            ...
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body text-center">
                ...
                <p className="text-base-content/70">High-speed internet throughout the property</p>
              </div>
            </div>
            ...
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body text-center">
                ...
                <p className="text-base-content/70">24/7 room service for your convenience</p>
              </div>
            </div>
          </div>
        </div>
