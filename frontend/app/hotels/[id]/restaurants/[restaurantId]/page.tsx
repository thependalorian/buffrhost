        ...
        <div className="container-warm py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="body-small text-nude-600">Hotel: {hotelId} | Restaurant: {restaurantId}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="card-default mb-6">
              ...
              <p className="body-regular text-nude-700 mb-4">
                Manage this restaurant within your hotel. Each hotel can have multiple restaurants with their own menus and services.
              </p>
              ...
              <div className="card-default">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="body-small text-nude-600">12 pending orders</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-nude-400 rounded-full"></div>
                    <span className="body-small text-nude-600">3 room service orders</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-semantic-success rounded-full"></div>
                    <span className="body-small text-nude-600">8 completed today</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="card-default">
              ...
              <div className="space-y-3">
                <div>
                  <span className="body-small font-medium text-nude-800">Restaurant ID:</span>
                  <span className="body-small text-nude-600 ml-2">{restaurantId}</span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span className="body-small text-nude-600 ml-2">Fine Dining</span>
                </div>
                <div>
            ...
            <div className="card-default">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="body-small font-medium text-nude-800">45</span>
                </div>
                <div className="flex justify-between">
                  <span className="body-small text-nude-600">Today's Orders</span>
                  <span className="body-small font-medium text-nude-800">23</span>
                </div>
                <div className="flex justify-between">
