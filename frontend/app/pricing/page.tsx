...
const addOns = [
  {
    ...
    price: "N$199",
    period: "per month",
    features: ["Voice recognition", "Multi-language support", "Advanced booking management"]
  },
  {
        ...
        <nav className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button className="btn btn-primary rounded-full" onClick={handleRequestDemo}>Request a Demo</button>
            </div>
          </div>
        </nav>
      </header>
        ...
        <section className="py-20 bg-sand-50 dark:bg-sand-900/20">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="max-w-3xl mx-auto text-xl text-gray-600 dark:text-gray-400 mb-8">
              Choose the perfect plan for your hospitality business. All plans include a 14-day free trial with no credit card required.
            </p>
            
            {/* Billing Toggle */}
            <div className="flex items-center justify-center space-x-4 mb-12">
              <span className={`text-lg ${!isAnnual ? 'font-semibold text-gray-900 dark:text-white' : 'text-gray-500'}`}>
                Monthly
              </span>
              <button
                  ...
                  >
                    ...
                    <div className="text-center mb-8">
                      ...
                      <div className="mb-4">
                        ...
                        <span className="text-gray-600 dark:text-gray-400">/{isAnnual ? 'per year' : plan.period}</span>
                      </div>
                    </div>
        ...
        <section className="py-20 bg-sand-50 dark:bg-sand-900/20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Add-ons & Extensions</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {addOns.map((addon, index) => (
                <div key={index} className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">{addon.description}</p>
                  <div className="mb-4">
                    <span className="text-2xl font-bold">{addon.price}</span>
                    <span className="text-gray-600 dark:text-gray-400">/{addon.period}</span>
                  </div>
                  ...
                  <button className="btn btn-outline w-full">Add to Plan</button>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
                <h3 className="text-xl font-bold mb-3">Do you offer custom pricing for large enterprises?</h3>
                <p className="text-gray-600 dark:text-gray-400">
                  Absolutely! Contact our sales team for custom pricing, dedicated support, and tailored solutions for large hospitality chains.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  We accept all major credit cards, bank transfers, and integrate with Adumo Online for secure payment processing in Namibia.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/demo" className="text-gray-600 dark:text-gray-400 hover:text-primary">Demo</a></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/docs" className="text-gray-600 dark:text-gray-400 hover:text-primary">Documentation</a></li>
                <li><a href="/status" className="text-gray-600 dark:text-gray-400 hover:text-primary">Status</a></li>
              </ul>
            </div>
          </div>
