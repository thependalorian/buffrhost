...
export default function RoomManagementPage() {
  return (
    <div className="container mx-auto p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-base-content">Room Management</h1>
        <p className="text-base-content/70 mt-2">
          Manage hotel rooms, bookings, and availability
        </p>
      </div>
                ...
                <table className="table table-zebra w-full">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>Deluxe</td>
                      <td><span className="badge badge-warning">Occupied</span></td>
                      <td>John Smith</td>
                    ...
                    <tr>
                      ...
                      <td>Suite</td>
                      <td><span className="badge badge-error">Maintenance</span></td>
                      <td>-</td>
                      <td>-</td>
                      <td>
                        <button className="btn btn-ghost btn-xs">View</button>
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <div className="space-y-3">
                ...
                <div className="text-sm">
                  <p className="font-medium text-warning">4:00 PM - Check-out</p>
                  <p className="text-base-content/70">Room 102 - Mike Johnson</p>
                </div>
                <div className="text-sm">
                  <p className="font-medium text-primary">6:00 PM - Check-in</p>
                  <p className="text-base-content/70">Room 301 - Sarah Wilson</p>
                </div>
              </div>
            </div>
          </div>
