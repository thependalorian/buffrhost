...
export const metadata: Metadata = {
  ...
  description:
    "Experience our comprehensive loyalty system that drives customer retention and increases revenue across all hospitality services.",
};
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2">
        <div className="container mx-auto px-6 text-center">
          <p className="text-sm">
            🎯 <strong>Loyalty Program Demo</strong> - Drive customer retention
            and revenue growth
          </p>
        </div>
      </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white max-w-4xl mx-auto px-6">
            ...
            <p className="text-xl md:text-2xl mb-6">
              Turn guests into lifelong customers
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Experience Our Loyalty System
              </h2>
              <p className="text-lg text-base-content/80 mb-6">
                Join the Etuna loyalty program and see how our system rewards
                guests across all services - from restaurant dining to hotel
                stays, tours, and spa treatments.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <p className="text-sm text-nude-700">
                  Earn points from restaurant dining, hotel stays, tours, spa
                  treatments, and more.
                </p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <p className="text-sm text-nude-700">
                  Bronze, Silver, Gold, and Platinum tiers with escalating
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <p className="text-sm text-nude-700">
                  AI-powered recommendations based on guest preferences and
                  behavior.
                </p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <p className="text-sm text-nude-700">
                  Use points immediately at checkout for discounts, free items,
                  or upgrades.
                </p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <p className="text-sm text-nude-700">
                  Refer friends, share experiences, and earn bonus points for
                  social engagement.
                </p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <p className="text-sm text-nude-700">
                  Track member behavior, redemption patterns, and program
                  performance.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-nude-700">
                Scan QR code or sign up online to become a member instantly.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-nude-700">
                Earn points on every purchase across all Etuna services.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-nude-700">
                Use points for discounts, free items, upgrades, and exclusive
                benefits.
              </p>
            </div>
          </div>
        ...
        <div className="py-16">
          <div className="container mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
              Experience the Loyalty Difference
            </h2>
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80">
                        See how loyalty drives satisfaction
                      </p>
                    </div>
                  </div>
                  <p className="text-white/90 mb-6">
                    Experience the personalized rewards and exclusive benefits
                    that keep guests coming back. From instant point earning to
                    tier upgrades, see how our loyalty system creates lasting
                    relationships.
                  </p>
                ...
                <div className="card-body">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-nude-700">
                        See how loyalty drives revenue
                      </p>
                    </div>
                  </div>
                  <p className="text-base-content/80 mb-6">
                    Explore our comprehensive loyalty management system. Track
                    member engagement, analyze redemption patterns, and optimize
                    your program for maximum ROI.
                  </p>
                  <div className="space-y-3">
                    <div className="flex items-center gap-2 text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-primary-content/80">
                  Contact us to implement a loyalty program that drives customer
                  retention.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-primary-content/80">
                  Book a personalized demonstration of our loyalty management
                  system.
                </p>
              </div>
              <div className="text-center">
