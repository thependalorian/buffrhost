...
export const metadata: Metadata = {
  title: 'Etuna Guesthouse - Financial Reports',
  description: 'Financial management and analytics for Etuna Guesthouse',
};
    ...
    <div className="min-h-screen nude-gradient-light">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-lg sm:text-2xl font-bold">Financial Reports</h1>
                  <p className="text-primary-content/80 text-xs sm:text-sm">Revenue, expenses, and financial analytics</p>
                </div>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl font-bold text-nude-800 mb-4">Revenue Sources</h2>
              ...
              {mockRevenueSources.map((source) => (
                <div key={source.id} className="flex items-center justify-between">
                  <div className="flex items-center space-x-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-sm sm:text-base font-medium text-nude-800">{source.name}</p>
                      <p className="text-xs sm:text-sm text-gray-500">{source.percentage}% of total revenue</p>
                    </div>
                  </div>
        ...
        <div className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl font-bold text-nude-800 mb-4">Expense Categories</h2>
                      ...
                      <tr key={expense.id} className="hover:bg-gray-50">
                        <td className="px-3 sm:px-6 py-3 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium text-nude-800">{expense.name}</span>
                          </div>
                        </td>
                        ...
                        <td className="px-3 sm:px-6 py-3 whitespace-nowrap">
                          <span className={`inline-flex items-center px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(expense.status)}`}>
                            ...
                            {expense.status === 'over' ? 'Over Budget' : 
                             expense.status === 'under' ? 'Under Budget' : 'On Track'}
                          </span>
                        </td>
                        <td className="px-3 sm:px-6 py-3 whitespace-nowrap text-sm text-gray-500">
                          {expense.percentage}%
        ...
        <div className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl font-bold text-nude-800 mb-4">Monthly Financial Overview</h2>
          <div className="nude-card rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            ...
            <div className="flex items-center justify-center space-x-6 mt-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs sm:text-sm text-nude-700">Expenses</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <Link href="/protected/etuna/finance" className="nude-card rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 hover:shadow-md transition-shadow group">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0">
