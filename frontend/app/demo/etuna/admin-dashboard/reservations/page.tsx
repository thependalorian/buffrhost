            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-primary-content/80">Manage room reservations and bookings</p>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4">
                  ...
                  {reservations.map((reservation) => (
                    <tr key={reservation.id}>
                      ...
                      <td>
                        ...
                        <div className="text-sm text-base-content/70">{reservation.email}</div>
                        <div className="text-sm text-base-content/70">{reservation.phone}</div>
                      </td>
                      <td>
                        <div className="font-medium">{reservation.roomType}</div>
                        <div className="text-sm text-base-content/70">Room {reservation.roomNumber}</div>
                      ...
                      <td>
                        <div className="text-sm">
                          <div className="font-medium">In: {reservation.checkIn}</div>
                          <div className="font-medium">Out: {reservation.checkOut}</div>
                        </div>
                      </td>
                      <td>
                        <div className="text-center">
                          <div className="font-semibold">{reservation.nights}</div>
                          <div className="text-xs text-base-content/70">nights</div>
                        </div>
                      </td>
                      <td>
                        <div className="text-right">
                          <div className="font-semibold">N$ {reservation.totalAmount}</div>
                      ...
                      <td>
                        <div className="flex space-x-1">
                          ...
                          <button className="btn btn-ghost btn-sm text-error" title="Cancel">
