...
export const metadata: Metadata = {
  title: 'Etuna Guesthouse - Analytics & Insights',
  description: 'Performance analytics and business insights for Etuna Guesthouse',
};
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-lg sm:text-2xl font-bold">Analytics & Insights</h1>
                  <p className="text-primary-content/80 text-xs sm:text-sm">Performance metrics and business intelligence</p>
                </div>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          {mockAnalyticsMetrics.map((metric) => {
            ...
            return (
              <div key={metric.id} className="nude-card rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
                <div className="flex items-center justify-between">
                  <div className="min-w-0 flex-1">
                    <p className="text-xs sm:text-sm font-medium text-nude-700">{metric.name}</p>
                    <p className="text-xl sm:text-2xl font-bold text-nude-800">
                      {metric.name === 'Average Rating' ? `${metric.value}/5` : 
                       metric.name === 'Occupancy Rate' ? `${metric.value}%` :
                       metric.name === 'Revenue Growth' ? `${metric.value}%` :
                       metric.value.toLocaleString()}
                    </p>
                    <div className="flex items-center mt-2">
                      <TrendIcon className={`h-4 w-4 mr-1 ${getTrendColor(metric.trend)}`} />
                      <span className={`text-xs sm:text-sm font-medium ${getTrendColor(metric.trend)}`}>
                        +{metric.change}%
                      </span>
        ...
        <div className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl font-bold text-nude-800 mb-4">Performance Metrics</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="nude-card rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-sm sm:text-base font-medium text-nude-800">Occupancy Rate</h3>
                <Bed className="h-5 w-5 text-blue-600" />
              </div>
              <div className="text-2xl sm:text-3xl font-bold text-nude-800 mb-2">{mockPerformanceMetrics.occupancyRate}%</div>
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div className="bg-blue-500 h-2 rounded-full" style={{ width: `${mockPerformanceMetrics.occupancyRate}%` }}></div>
              </div>
            </div>

            <div className="nude-card rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-sm sm:text-base font-medium text-nude-800">Average Daily Rate</h3>
                <DollarSign className="h-5 w-5 text-green-600" />
              </div>
              <div className="text-2xl sm:text-3xl font-bold text-nude-800 mb-2">N${mockPerformanceMetrics.averageDailyRate}</div>
              <div className="text-sm text-gray-500">Per room per night</div>
            </div>

            <div className="nude-card rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-sm sm:text-base font-medium text-nude-800">Guest Satisfaction</h3>
                <Star className="h-5 w-5 text-yellow-600" />
              </div>
              <div className="text-2xl sm:text-3xl font-bold text-nude-800 mb-2">{mockPerformanceMetrics.guestSatisfaction}/5</div>
              <div className="flex items-center">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className={`h-4 w-4 ${i < Math.floor(mockPerformanceMetrics.guestSatisfaction) ? 'text-yellow-400' : 'text-gray-300'}`} />
                ))}
              </div>
            </div>
          </div>
        ...
        <div className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl font-bold text-nude-800 mb-4">Guest Analytics</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Guest Demographics */}
            <div className="nude-card rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
              <h3 className="text-base sm:text-lg font-semibold text-nude-800 mb-4">Guest Demographics</h3>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-nude-700">Total Guests</span>
                  <span className="text-sm font-medium text-nude-800">{mockGuestAnalytics.totalGuests.toLocaleString()}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-nude-700">New Guests</span>
                  <span className="text-sm font-medium text-nude-800">{mockGuestAnalytics.newGuests.toLocaleString()}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-nude-700">Returning Guests</span>
                  <span className="text-sm font-medium text-nude-800">{mockGuestAnalytics.returningGuests.toLocaleString()}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-nude-700">Average Stay</span>
                  <span className="text-sm font-medium text-nude-800">{mockGuestAnalytics.averageStay} nights</span>
                </div>
              </div>
            </div>
            ...
            {/* Top Countries */}
            <div className="nude-card rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
              <h3 className="text-base sm:text-lg font-semibold text-nude-800 mb-4">Top Countries</h3>
              <div className="space-y-3">
                {mockGuestAnalytics.topCountries.slice(0, 5).map((country, index) => (
                  <div key={index} className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
                      <span className="text-sm text-nude-700">{country.country}</span>
                    </div>
                    <div className="text-right">
                      <span className="text-sm font-medium text-nude-800">{country.count}</span>
        ...
        <div className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl font-bold text-nude-800 mb-4">Revenue Analytics</h2>
          <div className="nude-card rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6">
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-nude-800">N${mockRevenueAnalytics.totalRevenue.toLocaleString()}</div>
                <div className="text-sm text-nude-700">Total Revenue</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-nude-800">N${mockRevenueAnalytics.averageBookingValue.toLocaleString()}</div>
                <div className="text-sm text-nude-700">Average Booking Value</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-nude-800">+{mockRevenueAnalytics.revenueGrowth}%</div>
                <div className="text-sm text-nude-700">Revenue Growth</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-nude-800">65.2%</div>
            ...
            {/* Revenue Sources */}
            <div className="space-y-4">
              <h3 className="text-base sm:text-lg font-semibold text-nude-800">Revenue Sources</h3>
              {mockRevenueAnalytics.topRevenueSources.map((source, index) => (
                <div key={index} className="flex items-center justify-between">
                  <div className="flex items-center space-x-3 min-w-0 flex-1">
                    <div className="w-4 h-4 bg-blue-500 rounded-full"></div>
                    <span className="text-sm text-nude-700">{source.source}</span>
                  </div>
                  <div className="text-right">
                    <span className="text-sm font-medium text-nude-800">N${source.amount.toLocaleString()}</span>
        ...
        <div className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl font-bold text-nude-800 mb-4">Monthly Trends</h2>
          <div className="nude-card rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            <div className="h-64 sm:h-80 flex items-end space-x-2 sm:space-x-4">
              {monthlyData.map((month, index) => (
                <div key={index} className="flex-1 flex flex-col items-center">
                  ...
                  <span className="text-xs sm:text-sm text-nude-700 mt-2">{month.month}</span>
            ...
            <div className="flex items-center justify-center space-x-6 mt-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs sm:text-sm text-nude-700">Revenue</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <Link href="/protected/etuna/analytics" className="nude-card rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 hover:shadow-md transition-shadow group">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0">
