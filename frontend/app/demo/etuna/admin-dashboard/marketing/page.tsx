/**
 * Etuna Marketing Automation - Professional Demo
 * 
 * Comprehensive marketing automation showcasing Buffr Host's lead generation capabilities
 * Features email campaigns, lead nurturing, conversion optimization, and analytics
 */
...
export const metadata: Metadata = {
  title: 'Etuna Guesthouse - Marketing Automation',
  description: 'Comprehensive marketing automation and lead generation for Etuna Guesthouse',
};
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-primary-content/80">Lead generation and conversion optimization</p>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4">
          ...
          <div className="stats shadow">
            <div className="stat">
              ...
              <div className="stat-value text-success">
                N$ {campaigns.reduce((sum, camp) => sum + camp.revenue, 0).toLocaleString()}
              </div>
          ...
          <div className="stats shadow">
            <div className="stat">
              ...
              <div className="stat-value text-warning">
                {Math.round(campaigns.reduce((sum, camp) => sum + camp.conversionRate, 0) / campaigns.length * 100) / 100}%
              </div>
          ...
          <div className="stats shadow">
            <div className="stat">
              ...
              <div className="stat-value text-info">
                {Math.round(campaigns.reduce((sum, camp) => sum + camp.roi, 0) / campaigns.length)}%
              </div>
                  ...
                  {campaigns.map((campaign) => (
                    <tr key={campaign.id}>
                      <td>
                        ...
                        <div className="text-sm text-base-content/70">{campaign.audience}</div>
                      </td>
                      <td>
                      ...
                      <td>
                        <div className="flex space-x-1">
                          ...
                          <button className="btn btn-ghost btn-sm" title="Analytics">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-base-content/70">
                    Machine learning algorithms automatically segment customers based on behavior and preferences
                  </div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-base-content/70">
                    Forecast customer behavior and optimize campaign timing for maximum conversion
                  </div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-base-content/70">
                    Personalized content that adapts based on customer data and interaction history
                  </div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <div className="font-semibold">Multi-Channel Orchestration</div>
                  <div className="text-sm text-base-content/70">
                    Coordinate campaigns across email, SMS, social media, and web channels
                  </div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-base-content/70">
                    Automated GDPR compliance, unsubscribe management, and data protection
                  </div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-base-content/70">
                    Continuous optimization of campaigns based on performance data and ROI metrics
                  </div>
                </div>
              </div>
            </div>
