...
export const metadata: Metadata = {
  title: 'Etuna Guesthouse - Demo Admin Dashboard',
  description: 'Demo showcase of Buffr Host platform capabilities for Etuna Guesthouse and Tours - No authentication required',
};
...
export default function EtunaDashboardPage() {
  ...
  const navigationItems = [
    {
      name: 'Dashboard',
      href: '/demo/etuna/admin-dashboard/dashboard',
      icon: BarChart3,
      current: true
    },
    {
      name: 'Reservations',
      href: '/demo/etuna/admin-dashboard/reservations',
      icon: Calendar,
      description: 'Manage room reservations and bookings'
    },
    {
      name: 'Guest Management',
      href: '/demo/etuna/admin-dashboard/guests',
      icon: Users,
      description: 'Guest check-ins, profiles, and history'
    },
    {
      name: 'Room Management',
      href: '/demo/etuna/admin-dashboard/rooms',
      icon: Bed,
      description: 'Room inventory, status, and maintenance'
    },
    {
      name: 'Restaurant',
      href: '/demo/etuna/admin-dashboard/restaurant',
      icon: Utensils,
      description: 'Menu management and order tracking'
    },
    {
      name: 'Tours & Activities',
      href: '/demo/etuna/admin-dashboard/tours',
      icon: Car,
      description: 'Tour bookings and activity scheduling'
    },
    {
      name: 'Financial Reports',
      href: '/demo/etuna/admin-dashboard/finance',
      icon: DollarSign,
      description: 'Revenue, expenses, and financial analytics'
    },
    {
      name: 'Analytics',
      href: '/demo/etuna/admin-dashboard/analytics',
      icon: BarChart,
      description: 'Performance metrics and insights'
    },
    {
      name: 'Communications',
      href: '/demo/etuna/admin-dashboard/communications',
      icon: MailIcon,
      description: 'Guest communications and notifications'
    },
    {
      name: 'Staff Management',
      href: '/demo/etuna/admin-dashboard/staff',
      icon: UserCheck,
      description: 'Staff scheduling and HR management'
    },
    {
      name: 'CRM & Leads',
      href: '/demo/etuna/admin-dashboard/crm',
      icon: Target,
      description: 'Customer relationship management'
    },
    {
      name: 'Marketing',
      href: '/demo/etuna/admin-dashboard/marketing',
      icon: Megaphone,
      description: 'Marketing automation and campaigns'
    },
    {
      name: 'Join Waitlist',
      href: '/demo/etuna/admin-dashboard/waitlist',
      icon: Crown,
      description: 'Waitlist management and conversions'
    },
    {
      name: 'Content Management',
      href: '/demo/etuna/admin-dashboard/cms',
      icon: FileText,
      description: 'CMS for all content types and media'
    },
    {
      name: 'Invoice Generation',
      href: '/demo/etuna/admin-dashboard/invoices',
      icon: Receipt,
      description: 'Automated invoice generation and management'
    },
    {
      name: 'Property Settings',
      href: '/demo/etuna/admin-dashboard/settings',
      icon: Settings,
  ...
  const recentBookings = reservations ? reservations.slice(0, 4).map(res => ({
      ...
      <div className="min-h-screen bg-base-200">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                <Link href="/guest/etuna" className="btn btn-ghost text-primary-content hover:bg-white/20 btn-sm sm:btn-md">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h1 className="text-lg sm:text-2xl font-bold">Etuna Admin Dashboard</h1>
                    <p className="text-primary-content/80 text-xs sm:text-sm">Manage your guesthouse operations</p>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2">
          <div className="container mx-auto px-4 sm:px-6 text-center">
            <p className="text-sm">
              🎯 <strong>Demo Admin Dashboard</strong> - No authentication required - Showcasing Buffr Host platform capabilities
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-8">
                      ...
                      <tr key={booking.id} className="hover:bg-nude-50">
                        ...
                        <td className="px-3 sm:px-6 py-3 whitespace-nowrap text-sm text-nude-700">
                          <div className="flex flex-col">
                            <span className="text-xs">Check-in: {booking.checkIn}</span>
                            <span className="text-xs">Check-out: {booking.checkOut}</span>
                          </div>
                        </td>
          ...
          <div className="mb-6 sm:mb-8">
            <h2 className="text-lg sm:text-xl font-bold text-nude-800 mb-4">Monthly Revenue</h2>
            <div className="nude-card p-4 sm:p-6">
