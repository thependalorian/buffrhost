...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive invoice management and generation for Etuna Guesthouse',
};
  ...
  const invoices = [
    {
      ...
      items: [
        { description: 'Executive Room (3 nights)', quantity: 1, rate: 12000, amount: 36000 },
        { description: 'Conference Facilities', quantity: 1, rate: 5000, amount: 5000 },
        { description: 'Catering Services', quantity: 1, rate: 4000, amount: 4000 }
      ],
      subtotal: 45000,
      tax: 0,
      total: 45000
    },
    {
      ...
      paymentMethod: null,
      items: [
        { description: 'Wedding Reception (80 guests)', quantity: 1, rate: 20000, amount: 20000 },
        { description: 'Room Block (10 rooms)', quantity: 1, rate: 5000, amount: 5000 }
      ],
      subtotal: 25000,
      tax: 0,
      total: 25000
    },
    {
      ...
      paymentMethod: null,
      items: [
        { description: 'Conference Hall (200 delegates)', quantity: 1, rate: 50000, amount: 50000 },
        { description: 'Catering (3 days)', quantity: 1, rate: 20000, amount: 20000 },
        { description: 'Audio Visual Equipment', quantity: 1, rate: 10000, amount: 10000 }
      ],
      subtotal: 80000,
      tax: 0,
      total: 80000
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-primary-content/80">Automated invoice management and financial reporting</p>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4">
          ...
          <div className="stats shadow">
            <div className="stat">
              ...
              <div className="stat-value text-info">
                N$ {invoices.reduce((sum, inv) => sum + inv.amount, 0).toLocaleString()}
              </div>
              <div className="stat-desc">This month</div>
            </div>
          </div>
                  ...
                  {invoices.map((invoice) => (
                    <tr key={invoice.id}>
                      <td>
                        ...
                        <div className="text-sm text-base-content/70">{invoice.email}</div>
                      </td>
                      <td>
                      ...
                      <td>
                        <div className={invoice.status === 'overdue' ? 'text-error' : ''}>
                          {invoice.dueDate}
                        </div>
                      </td>
                      <td>
