            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-primary-content/80">Manage room inventory and status</p>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <div className="card-body">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p className="text-xs text-base-content/50">Floor {room.floor} • {room.size}</p>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-primary">N$ {room.rate}</span>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="font-semibold text-sm text-base-content/70">Amenities</div>
