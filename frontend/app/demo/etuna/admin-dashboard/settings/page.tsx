...
interface PropertySetting {
  id: string;
  category: 'general' | 'booking' | 'payment' | 'communication' | 'security' | 'integration';
  name: string;
  description: string;
  value: any;
  type: 'text' | 'number' | 'boolean' | 'select' | 'multiselect' | 'date' | 'time' | 'datetime';
  options?: string[];
  required: boolean;
  editable: boolean;
}
...
export default function EtunaSettingsPage() {
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      ...
      case 'integration': return 'bg-gray-100 text-gray-800';
    ...
    <div className="min-h-screen bg-base-200">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-primary-content/80 text-xs sm:text-sm">Property configuration and system settings</p>
                </div>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">Property Settings</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {Object.entries(
              mockPropertySettings.reduce((acc, setting) => {
                ...
                <div key={category} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
                  ...
                  <div className="space-y-4">
                    {settings.map((setting) => (
                      <div key={setting.id} className="border-b border-gray-100 pb-4 last:border-b-0">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6">
            <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-0">User Management</h2>
        ...
        <div className="mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">System Settings</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            {Object.entries(
              mockSystemSettings.reduce((acc, setting) => {
                if (!acc[setting.category]) acc[setting.category] = [];
                acc[setting.category].push(setting);
                return acc;
              ...
              return (
                <div key={category} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
                  ...
                  <div className="space-y-3">
                    {settings.map((setting) => (
                      <div key={setting.id} className="border-b border-gray-100 pb-3 last:border-b-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <Link href="/protected/etuna/settings" className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 hover:shadow-md transition-shadow group">
            <div className="flex items-center space-x-3">
