...
export const metadata: Metadata = {
  title: 'Etuna Guesthouse - CMS Content Management',
  description: 'Comprehensive content management system for Etuna Guesthouse',
};
...
export default function EtunaCMSPage() {
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      case 'image':
        return <Image className="w-5 h-5 text-primary" alt="Image icon" />;
      case 'video':
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-primary-content/80">Comprehensive CMS for all content types</p>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-base-content/70 capitalize">{item.type}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-base-content/70">
                    Categorize content with tags, collections, and custom metadata
                  </div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
