...
export const metadata: Metadata = {
  ...
  description:
    "See how the Buffr Host management dashboard works with real-time data and analytics.",
};
    ...
    <div className="min-h-screen bg-base-200">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2">
        <div className="container mx-auto px-6 text-center">
          <p className="text-sm">
            🎯 <strong>Management Demo</strong> - This is a showcase of our
            management platform
          </p>
        </div>
      </div>
          ...
          <div className="nude-card">
            <div className="card-body">
              ...
              <div className="space-y-3">
                {dashboardData?.recent_reservations.map(
                  (reservation, index) => (
                    <div
                      key={index}
        ...
        <div className="alert alert-info">
          ...
          <div>
            ...
            <div className="text-sm">
              This is a demonstration of the Buffr Host management platform. All
              data shown is simulated for showcase purposes.
