              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold">
                    Join Buffr Host Waitlist
                  </h1>
                  <p className="text-primary-content/80">
                    Be among the first to experience the future of hospitality
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-primary-content/80 mb-8 max-w-3xl mx-auto">
            Join 500+ hospitality businesses already on the waitlist for Buffr
            Host - the complete ecosystem that automates operations, boosts
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          <div className="card bg-white/10 backdrop-blur-sm text-primary-content">
            <div className="card-body text-center">
              ...
              <p className="text-primary-content/80">
                Free your staff from repetitive tasks with AI-powered
                automation. Focus on what matters - delighting your customers.
              </p>
            </div>
          </div>
          ...
          <div className="card bg-white/10 backdrop-blur-sm text-primary-content">
            <div className="card-body text-center">
              ...
              <p className="text-primary-content/80">
                Make data-driven decisions with advanced analytics, predictive
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-primary-content/70">
                    Complete HR system with scheduling, performance tracking,
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-primary-content/70">
                    Intelligent lead scoring, automated follow-ups, and
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-primary-content/70">
                    Email campaigns, lead nurturing, and ROI optimization across
                    all channels
                  </div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-primary-content/70">
                    24/7 AI assistant handling bookings, inquiries, and customer
                    service
                  </div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-primary-content/70">
                    Comprehensive dashboards with predictive insights and
                    performance metrics
                  </div>
                </div>
              </div>
                ...
                <div className="form-control">
                  <label className="label cursor-pointer">
                    ...
                    <span className="label-text text-primary-content ml-3">
                      I agree to receive updates about Buffr Host and understand
                      that early access is limited.
                    </span>
                  </label>
                </div>
