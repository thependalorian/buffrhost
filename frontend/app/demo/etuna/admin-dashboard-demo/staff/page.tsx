...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive staff management and HR operations for Etuna Guesthouse",
};
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-primary-content/80">
                    Comprehensive HR and workforce management
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-base-content/70">
                    AI-powered shift optimization based on demand patterns and
                    staff preferences
                  </div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-base-content/70">
                    Real-time performance metrics with automated feedback and
                    goal setting
                  </div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-base-content/70">
                    Track competencies, identify training needs, and plan career
                    development
                  </div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-base-content/70">
                    Integrated messaging, announcements, and team collaboration
                    tools
                  </div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-base-content/70">
                    Automated compliance tracking, training records, and
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-base-content/70">
                    Advanced analytics for workforce optimization and strategic
                    planning
                  </div>
                </div>
              </div>
