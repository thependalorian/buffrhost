...
export default function EtunaRestaurantPage() {
  ...
  const orders = [
    ...
    },
    {
      ...
      status: "delivered",
      totalAmount: 95,
      items: [{ name: "Grilled Fish", quantity: 1, price: 95 }],
  ...
  const menuItems = [
    {
      ...
      price: 120,
      description:
        "Authentic Namibian traditional cuisine with meat and vegetables",
      preparationTime: 30,
      isAvailable: true,
      isPopular: true,
      calories: 450,
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-primary-content/80">
                    Manage menu, orders, and dining operations
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select className="select select-bordered w-full" required>
                    ...
                    <option value="Chef Maria">Chef Maria</option>
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full p-6">
            ...
            >
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <input type="checkbox" className="checkbox mr-2" />
                  <label className="text-sm">Popular item</label>
                </div>
              </div>
              <div className="flex gap-3 mt-6">
                <button type="submit" className="btn btn-primary flex-1">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="input input-bordered w-full"
                      defaultValue={selectedOrder.tableNumber}
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1">
                    ...
                    <input
                      ...
                      required
                      className="input input-bordered w-full"
                      defaultValue={selectedOrder.guestName}
                    />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea
                    className="textarea textarea-bordered w-full"
                    rows={2}
                    defaultValue={selectedOrder.specialRequests}
                  ></textarea>
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">
                  ...
                  <select
                    className="select select-bordered w-full"
                    defaultValue={selectedOrder.assignedChef}
                  >
                    <option value="Chef Maria">Chef Maria</option>
                    <option value="Chef Ahmed">Chef Ahmed</option>
                    <option value="Chef Sarah">Chef Sarah</option>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className="input input-bordered w-full"
                    defaultValue={selectedOrder.estimatedTime}
