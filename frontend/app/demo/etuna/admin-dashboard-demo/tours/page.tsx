...
const mockTours: Tour[] = [
  {
    ...
    status: "Active",
    description:
      "Experience the world-renowned Etosha National Park with our professional guides. Spot the Big Five and other incredible wildlife in their natural habitat.",
    highlights: [
  ...
  },
  {
    ...
    status: "Active",
    description:
      "Immerse yourself in the rich cultural heritage of the Himba people. Learn about their traditions, customs, and way of life.",
    highlights: [
      "Cultural immersion",
  ...
  },
  {
    ...
    status: "Seasonal",
    description:
      "Discover the spectacular Ruacana Falls, one of Namibia's most impressive natural wonders. Best viewed after the rainy season.",
    highlights: [
  ...
  },
  {
    ...
    status: "Active",
    description:
      "Explore the historical Omhedi Palace and learn about the rich cultural heritage of the region.",
    highlights: [
  ...
  },
  {
    ...
    status: "Active",
    description:
      "Visit ancient Baobab trees and learn about their cultural and ecological significance in local folklore.",
    highlights: [
      "Ancient trees",
      "Local folklore",
      "Natural heritage",
  ...
  },
  {
    ...
    status: "Active",
    description:
      "Experience the world-famous red sand dunes of Sossusvlei. A once-in-a-lifetime adventure in the Namib Desert.",
    highlights: [
      "Red sand dunes",
      "Desert adventure",
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-primary-content/80 text-xs sm:text-sm">
                    Manage tour bookings and activities
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6">
            <h2 className="text-lg sm:text-xl font-bold text-nude-800 mb-2 sm:mb-0">
              Tour Packages
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {mockTours.map((tour) => {
              ...
              return (
                <div
                  key={tour.id}
                  className="nude-card rounded-lg shadow-sm border border-gray-200 overflow-hidden"
                >
                  ...
                  <div className="p-4 sm:p-6">
                    <div className="flex items-start justify-between mb-3">
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-center space-x-2 mb-2">
                          <span
                            className={`px-2 py-1 text-xs font-medium rounded-full ${getTourTypeColor(
                              tour.type,
                            )}`}
                          >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="text-lg font-bold text-nude-800">
                          N${tour.price.toLocaleString()}
                        </p>
                      </div>
                    </div>
                  </div>
