...
export default function AdvancedReportingDemoPage() {
  return (
    <div className="min-h-screen bg-base-100">
      ...
      {/* Hero Section */}
      <div className="relative h-96 md:h-[500px] bg-gradient-to-br from-rose-600 to-pink-600">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-rose-50 rounded-lg">
                    ...
                    <div className="text-right">
                      <p className="text-sm text-rose-600">Scheduled</p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-6 h-6 text-green-500" />
                  <span>Automated report delivery</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-6 h-6 text-green-500" />
              ...
              <div className="absolute -bottom-6 -right-6 bg-white dark:bg-base-200 p-4 rounded-lg shadow-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-nude-700">Custom Analytics</p>
                  </div>
                </div>
              </div>
            </div>
