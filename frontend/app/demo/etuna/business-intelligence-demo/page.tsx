...
export const metadata: Metadata = {
  ...
  description: 'Experience our advanced business intelligence platform with comprehensive analytics, reporting, and data visualization.',
};
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2">
        <div className="container mx-auto px-6 text-center">
          <p className="text-sm">
            🎯 <strong>Business Intelligence Demo</strong> - Advanced analytics and data-driven insights
          </p>
        </div>
      </div>
      ...
      <div className="relative h-96 md:h-[500px] bg-gradient-to-br from-emerald-600 to-teal-600">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white max-w-4xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-4">Business Intelligence</h1>
            <p className="text-xl md:text-2xl mb-6">Advanced analytics and data-driven insights</p>
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Advanced Business Intelligence</h2>
              <p className="text-lg text-base-content/80 mb-6">
                See how our business intelligence platform provides comprehensive analytics, 
                interactive dashboards, and data-driven insights across all Etuna operations 
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-emerald-50 rounded-lg">
                    ...
                    <div className="text-right">
                      <p className="text-sm text-emerald-600 font-bold">+15.2%</p>
        ...
        {/* BI Benefits */}
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-nude-800">Why Our Business Intelligence Excels</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <p className="text-sm text-nude-700">Customizable dashboards with real-time data visualization and drill-down capabilities.</p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <p className="text-sm text-nude-700">Statistical analysis, trend identification, and predictive modeling.</p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <p className="text-sm text-nude-700">Automated report generation with scheduled delivery and custom formats.</p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <h3 className="font-semibold mb-2 text-nude-800">Data Integration</h3>
                <p className="text-sm text-nude-700">Seamless integration with multiple data sources and external systems.</p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <h3 className="font-semibold mb-2 text-nude-800">Self-Service Analytics</h3>
                <p className="text-sm text-nude-700">User-friendly tools for non-technical users to create their own reports.</p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <p className="text-sm text-nude-700">Access dashboards and reports on mobile devices with responsive design.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-nude-800">Analytics Categories & Insights</h2>
              ...
              <div className="card-body">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-nude-700">Customer behavior insights</p>
                  </div>
                </div>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
        ...
        {/* Advanced Features */}
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-nude-800">Advanced BI Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Machine Learning Analytics</h3>
              <p className="text-nude-700">AI-powered insights, anomaly detection, and predictive analytics.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-nude-700">Streaming analytics and real-time data processing for instant insights.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-nude-700">Interactive charts, graphs, and visualizations for better data understanding.</p>
            </div>
          </div>
        </div>
        ...
        <div className="py-16">
          <div className="container mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Experience Business Intelligence</h2>
                ...
                <div className="card-body">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80">See how business intelligence works</p>
                    </div>
                  </div>
                  <p className="text-white/90 mb-6">
                    Experience our business intelligence platform. 
                    Explore interactive dashboards, analyze trends, 
                    create custom reports, and discover insights 
              ...
              <div className="card bg-base-100 shadow-xl">
                <div className="card-body">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold">BI Management Dashboard</h3>
                      <p className="text-nude-700">See how analytics drive business success</p>
                    </div>
                  </div>
                  <p className="text-base-content/80 mb-6">
                    Explore our business intelligence management dashboard. 
                    Configure analytics, create custom reports, 
                    manage data sources, and optimize insights 
          ...
          <div className="card-body">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-primary-content/80">Contact us to implement business intelligence.</p>
              </div>
              <div className="text-center">
                <Mail className="w-8 h-8 mx-auto mb-4" />
                <h3 className="font-bold text-lg mb-2">Schedule a Demo</h3>
                <p className="text-primary-content/80">Book a personalized demonstration of our BI platform.</p>
              </div>
              <div className="text-center">
