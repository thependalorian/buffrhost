...
export const metadata: Metadata = {
  ...
  description: 'Experience our native mobile applications for iOS and Android with full platform integration.',
};
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2">
        <div className="container mx-auto px-6 text-center">
          <p className="text-sm">
            🎯 <strong>Mobile App Demo</strong> - Native iOS and Android applications
          </p>
        </div>
      </div>
      ...
      <div className="relative h-96 md:h-[500px] bg-gradient-to-br from-indigo-600 to-purple-600">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white max-w-4xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-4">Mobile Excellence</h1>
            <p className="text-xl md:text-2xl mb-6">Native iOS and Android applications</p>
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Native Mobile Applications</h2>
              <p className="text-lg text-base-content/80 mb-6">
                See how our native mobile applications deliver the complete Buffr Host 
                experience on iOS and Android devices, with offline capabilities, 
                push notifications, and seamless integration with all platform features.
              </p>
                  ...
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Full functionality without internet</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Built-in camera integration</p>
                      </div>
                    </div>
                    <div className="text-right">
        ...
        {/* Mobile App Benefits */}
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-nude-800">Why Our Mobile Apps Excel</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <h3 className="font-semibold mb-2 text-nude-800">Native Performance</h3>
                <p className="text-sm text-nude-700">Optimized native apps with smooth animations and fast loading.</p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <h3 className="font-semibold mb-2 text-nude-800">Offline Capabilities</h3>
                <p className="text-sm text-nude-700">Full functionality without internet connection for core features.</p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <h3 className="font-semibold mb-2 text-nude-800">Push Notifications</h3>
                <p className="text-sm text-nude-700">Real-time updates and alerts for bookings, payments, and messages.</p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <h3 className="font-semibold mb-2 text-nude-800">QR Code Integration</h3>
                <p className="text-sm text-nude-700">Built-in camera for QR code scanning and contactless access.</p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <h3 className="font-semibold mb-2 text-nude-800">Biometric Security</h3>
                <p className="text-sm text-nude-700">Fingerprint and face recognition for secure access.</p>
              </div>
            </div>
            ...
            <div className="nude-card hover:shadow-nude transition-shadow">
              <div className="card-body text-center">
                ...
                <h3 className="font-semibold mb-2 text-nude-800">Cross-Platform Sync</h3>
                <p className="text-sm text-nude-700">Seamless synchronization across web, iOS, and Android.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* App Features */}
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-nude-800">Mobile App Features</h2>
              ...
              <div className="card-body">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-nude-700">Customer mobile experience</p>
                  </div>
                </div>
              ...
              <div className="card-body">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-nude-700">Employee mobile tools</p>
                  </div>
                </div>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
              ...
              <div className="card-body">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-nude-700">Executive mobile dashboard</p>
                  </div>
                </div>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
        ...
        {/* Advanced Features */}
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-nude-800">Advanced Mobile Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-nude-700">AR-powered room tours, menu visualization, and property navigation.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-nude-700">Hands-free operation with natural language voice commands.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-nude-700">GPS-based services, proximity alerts, and location-aware features.</p>
            </div>
          </div>
        </div>
        ...
        <div className="py-16">
          <div className="container mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Experience Mobile Apps</h2>
              ...
              <div className="card bg-gradient-to-br from-indigo-500 to-purple-500 text-white shadow-xl">
                <div className="card-body">
                  ...
                  <p className="text-white/90 mb-6">
                    Experience our native mobile applications. 
                    Download the apps, explore features, 
                    test offline capabilities, and see how 
                ...
                <div className="card-body">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-nude-700">See how mobile drives platform success</p>
                    </div>
                  </div>
                  <p className="text-base-content/80 mb-6">
                    Explore our mobile management dashboard. 
                    Configure app settings, manage push 
                    notifications, monitor usage analytics, 
          ...
          <div className="card-body">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-primary-content/80">Contact us to implement mobile applications.</p>
              </div>
              <div className="text-center">
                <Mail className="w-8 h-8 mx-auto mb-4" />
                <h3 className="font-bold text-lg mb-2">Schedule a Demo</h3>
                <p className="text-primary-content/80">Book a personalized demonstration of our mobile apps.</p>
              </div>
              <div className="text-center">
