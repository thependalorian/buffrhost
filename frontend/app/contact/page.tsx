      ...
      <main className="flex-grow">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
            {/* Contact Form */}
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-lg overflow-hidden">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 md:mb-6 truncate">
                Get in Touch
              </h2>
              <p className="text-sm sm:text-base md:text-lg text-nude-700 mb-4 sm:mb-6 break-words">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-lg overflow-hidden">
                <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 truncate">
                  Support Resources
                </h2>
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-nude-800 truncate">
                      Frequently Asked Questions
                    </h3>
                    <p className="text-sm sm:text-base text-nude-600 break-words mt-1">
                      Find quick answers to common questions about Buffr Host
                      platform features, pricing, and implementation.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-nude-800 truncate">
                    ...
                    <p className="text-sm sm:text-base text-nude-600 break-words mt-1">
                      Comprehensive guides and tutorials to help you get the
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-nude-600 break-words mt-1">
                      Step-by-step video guides for setting up and using Buffr
                      Host features.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-nude-600 break-words mt-1">
                      For critical issues, use the form above with "Emergency"
                      as the inquiry type
                    </p>
                  </div>
                </div>
