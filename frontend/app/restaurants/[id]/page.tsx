...
import { ArrowLeft, Utensils, Calendar, Users, Settings, Star, Clock } from "lucide-react";
        ...
        <div className="container-warm py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="body-small text-nude-600">Restaurant ID: {restaurantId}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container-warm py-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <div className="card-default card-interactive">
            ...
            <p className="body-regular text-nude-600 mb-4">Manage menu items, categories, and pricing</p>
          ...
          <div className="card-default card-interactive">
            ...
            <p className="body-regular text-nude-600 mb-4">Manage table reservations and seating</p>
            <button className="btn-emotional-primary w-full">View Reservations</button>
          </div>
          
          <div className="card-default card-interactive">
            <Clock className="h-8 w-8 text-luxury-charlotte mb-4" />
            <h3 className="heading-card mb-2">Orders</h3>
            <p className="body-regular text-nude-600 mb-4">Manage dine-in and takeout orders</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <div className="card-default card-interactive">
            ...
            <p className="body-regular text-nude-600 mb-4">Manage staff schedules and performance</p>
            <button className="btn-emotional-secondary w-full">Manage Staff</button>
          </div>
          
          <div className="card-default card-interactive">
            <Star className="h-8 w-8 text-luxury-charlotte mb-4" />
            <h3 className="heading-card mb-2">Customer Reviews</h3>
            <p className="body-regular text-nude-600 mb-4">View and respond to customer feedback</p>
            <button className="btn-emotional-secondary w-full">View Reviews</button>
          </div>
          
          <div className="card-default card-interactive">
            <Settings className="h-8 w-8 text-luxury-charlotte mb-4" />
            <h3 className="heading-card mb-2">Restaurant Settings</h3>
            <p className="body-regular text-nude-600 mb-4">Configure restaurant preferences</p>
          ...
          <div className="card-default">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="body-small text-nude-600">New order received</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-nude-400 rounded-full"></div>
                <span className="body-small text-nude-600">Reservation confirmed</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-semantic-success rounded-full"></div>
                <span className="body-small text-nude-600">Order completed</span>
              </div>
            </div>
          </div>
        </div>
