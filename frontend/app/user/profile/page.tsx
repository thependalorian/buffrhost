        ...
        <div className="container-warm py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="body-small text-nude-600">Manage your account and preferences</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="md:col-span-2">
            <div className="card-default mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <label className="body-small font-medium text-nude-800">Full Name</label>
                  <input 
                    type="text" 
                ...
                <div>
                  <label className="body-small font-medium text-nude-800">Email</label>
                  <input 
                    type="email" 
                    className="w-full p-3 border border-nude-300 rounded-lg focus:ring-2 focus:ring-luxury-charlotte focus:border-transparent"
                ...
                <div>
                  <label className="body-small font-medium text-nude-800">Phone</label>
                  <input 
                    type="tel" 
                    className="w-full p-3 border border-nude-300 rounded-lg focus:ring-2 focus:ring-luxury-charlotte focus:border-transparent"
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4 p-3 bg-nude-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="body-small text-nude-600">3 upcoming reservations</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 p-3 bg-nude-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="body-small text-nude-600">12 orders this month</p>
                  </div>
                </div>
              </div>
            </div>
