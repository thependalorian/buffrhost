...
test.describe('Etuna Showcase E2E', () => {
  ...
  test('should display Etuna dashboard with all sections', async ({ page }) => {
    ...
    await expect(page.getByText('Comprehensive hospitality management for Etuna Guesthouse')).toBeVisible();
  ...
  test('should navigate to AI assistant page', async ({ page }) => {
    ...
    await expect(page.getByText('Enhanced AI concierge with LangGraph & Pydantic architecture')).toBeVisible();
    await expect(page.getByText('Welcome to Etuna Guesthouse & Tours!')).toBeVisible();
  ...
  test('should navigate to staff management page', async ({ page }) => {
    ...
    await expect(page.getByText('Staff Management')).toBeVisible();
    await expect(page.getByText('Comprehensive staff and HR management for Etuna Guesthouse')).toBeVisible();
  ...
  test('should navigate to CRM page', async ({ page }) => {
    ...
    await expect(page.getByText('Comprehensive CRM and lead management for Etuna Guesthouse')).toBeVisible();
  ...
  test('should navigate to marketing page', async ({ page }) => {
    ...
    await expect(page.getByText('Comprehensive marketing automation and lead generation for Etuna Guesthouse')).toBeVisible();
  ...
  test('should navigate to CMS page', async ({ page }) => {
    ...
    // Check CMS elements
    await expect(page.getByText('Content Management')).toBeVisible();
    await expect(page.getByText('Comprehensive content management system for Etuna Guesthouse')).toBeVisible();
  ...
  test('should navigate to invoice generation page', async ({ page }) => {
    ...
    await expect(page.getByText('Invoice Generation')).toBeVisible();
    await expect(page.getByText('Comprehensive invoice management and generation for Etuna Guesthouse')).toBeVisible();
  ...
  test('should navigate to waitlist page', async ({ page }) => {
    ...
    await expect(page.getByText('Join the waitlist for Buffr Host - The complete hospitality management platform')).toBeVisible();
    
    // Check compelling headline
    await expect(page.getByText('Transform Your Hospitality Business')).toBeVisible();
    await expect(page.getByText('Join 500+ businesses already on the waitlist')).toBeVisible();
