  ...
  return (
    <form onSubmit={handleSubmit} className="subscription-form">
      ...
      <div>
        ...
        <input type="text" id="plan_name" name="plan_name" value={formData.plan_name} onChange={handleChange} required />
      </div>
      <div>
      ...
      <div>
        ...
        <input type="text" id="billing_period" name="billing_period" value={formData.billing_period || ''} onChange={handleChange} />
      </div>
