...
const CommissionStructureForm: React.FC<CommissionStructureFormProps> = ({ onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="commission-structure-form">
      ...
      <div>
        ...
        <input type="text" id="commission_type" name="commission_type" value={formData.commission_type || ''} onChange={handleChange} />
      </div>
      <div>
      ...
      <div>
        ...
        <input type="text" id="applies_to_role" name="applies_to_role" value={formData.applies_to_role || ''} onChange={handleChange} />
      </div>
      <div>
