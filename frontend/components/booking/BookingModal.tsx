...
export const BookingModal: React.FC<BookingModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isRestaurant && (!formData.reservationDate || !formData.reservationTime)) {
        ...
        <div className="p-6">
          ...
          {success ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600">Your {isHotel ? 'reservation' : 'booking'} has been submitted successfully.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <BuffrButton
                  ...
                  className="flex-1"
                >
                  {isSubmitting ? 'Submitting...' : (isHotel ? 'Book Now' : 'Reserve Table')}
                </BuffrButton>
              </div>
            </form>
          )}
