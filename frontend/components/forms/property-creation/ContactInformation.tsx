...
/**
 * ContactInformation React Component for Buffr Host Hospitality Platform
 * @fileoverview ContactInformation handles form input and validation for user data collection
 * @location buffr-host/components/forms/property-creation/ContactInformation.tsx
 * @purpose ContactInformation handles form input and validation for user data collection
 ...
 *
 * Props:
 * @param {ContactFormData} [formData] - formData prop description
 * @param {string} [propertyType] - propertyType prop description
 ...
 * @method isValidPhone - isValidPhone method for component functionality
 * @method isValidEmail - isValidEmail method for component functionality
 ...
 * }
 *
 * @returns {JSX.Element} Rendered ContactInformation component
 */
