...
/**
 * AIAgentChat React Component for Buffr Host Hospitality Platform
 * @fileoverview AIAgentChat enables AI-powered conversational interfaces
 * @location buffr-host/components/ai-chat/ai-agent-chat.tsx
 * @purpose AIAgentChat enables AI-powered conversational interfaces
 ...
 *
 * Methods:
 * @method scrollToBottom - scrollToBottom method for component functionality
 * @method handleKeyPress - handleKeyPress method for component functionality
 * @method clearChat - clearChat method for component functionality
 *
 * Usage Example:
 * @example
 ...
 * }
 *
 * @returns {JSX.Element} Rendered AIAgentChat component
 */
...
export default function AIAgentChat({ className = '' }: AIAgentChatProps) {
  ...
  //       },
  //       previousDecisions: messages as any
  ...
  //     } else {
  //       // Use specific agent
  //       let agent: 'strategic' | 'financial' | 'operational';
  //       if (selectedAgent === 'alex') {
  //         agent = 'strategic';
  //       } else if (selectedAgent === 'sarah') {
  //         agent = 'financial';
  //       } else {
  //         agent = 'operational';
  //       }
