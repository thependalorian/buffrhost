...
const Button: React.FC<ButtonProps> = ({ onClick, children, className = '', size = 'md', variant = 'default' }) => {
  const sizeClasses = {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl md:text-2xl text-nude-100 leading-relaxed">
          ...
          <div className="relative hidden lg:block">
            <div className="grid grid-cols-2 gap-4">
              <div className="pt-12">
                <img src="https://images.unsplash.com/photo-1571896349842-33c89424de2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Hotel Pool" className="rounded-2xl shadow-luxury-medium" />
              </div>
              <div>
                <img src="https://images.unsplash.com/photo-1631049307264-da0ec9d70304?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Hotel Room" className="rounded-2xl shadow-luxury-medium" />
              </div>
              <div className="col-span-2">
                 <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" alt="Hotel Exterior" className="rounded-2xl shadow-luxury-medium" />
              </div>
            </div>
          </div>
        </div>
