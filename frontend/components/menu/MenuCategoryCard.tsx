...
export class MenuCategoryCard {
  ...
  private getCategoryImage(categoryName: string): string {
    const imageMap: Record<string, string> = {
      'Light Meals': 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=100&h=100&fit=crop&crop=center',
      'Main Course': 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=100&h=100&fit=crop&crop=center',
      'Traditional Cuisine': 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=100&h=100&fit=crop&crop=center',
      'Pizza': 'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=100&h=100&fit=crop&crop=center',
      'Desserts': 'https://images.unsplash.com/photo-1551024506-0bccd828d307?w=100&h=100&fit=crop&crop=center',
      'Hot Beverages': 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=100&h=100&fit=crop&crop=center',
      'Platters': 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=100&h=100&fit=crop&crop=center',
      'Soft Drinks': 'https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?w=100&h=100&fit=crop&crop=center',
      'Beers': 'https://images.unsplash.com/photo-1608270586620-248524c67de9?w=100&h=100&fit=crop&crop=center',
      'Wine': 'https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=100&h=100&fit=crop&crop=center',
      'Spirits': 'https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?w=100&h=100&fit=crop&crop=center'
    };
    return imageMap[categoryName] || 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=100&h=100&fit=crop&crop=center';
  }
        ...
        <div className="card-body">
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-base-content/70">{this.getCategoryDescription(this.category.name)}</p>
            </div>
          </div>
